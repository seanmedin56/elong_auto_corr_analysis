function hs = gen_auto_cor4(traces, derivs, ...
...
corr = cross_corr_m_calc4(traces, traces, max_delay);

if bootstraps
    std_derivs = corr_bootstraps(traces,traces, max_delay,100, max(derivs),'m3');
end
