function [traces arrival_traces] = gen_data_var_len(elong_vars,time_res,points_per_trace, ...
...
arrival_traces = cell([1,num_traces]);
...
for i = 1:num_traces
    [traces{i}, arrival_traces{i}] = gillespie_var_len(elong_func, time_res, points_per_trace, ...
