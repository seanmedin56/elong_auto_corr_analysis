function auto = fin_corr2(trace1, trace2, max_delay)

% calculates central moment
% does not normalize individual correlations
% does weigh individual correlations by number of points per trace
