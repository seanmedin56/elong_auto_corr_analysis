function hs = gen_auto_cor2(traces, derivs, ...
...
corr = cross_corr_m_calc2(traces, traces, max_delay);

if bootstraps
    std_derivs = corr_bootstraps(traces,traces, max_delay,100, max(derivs),'m1');
end
