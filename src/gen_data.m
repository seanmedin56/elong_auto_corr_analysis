function [traces,instant_traces] = gen_data(elong_time,time_res,points_per_trace, ...
...
instant_traces = cell([1, num_traces]);
for i = 1:num_traces
    [traces{i},instant_traces{i}] = gillespie_gen(elong_time, time_res, points_per_trace, ...
